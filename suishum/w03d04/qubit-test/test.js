var test$ = function() { // eslint-disable-line no-unused-vars
  window.answerList = {
    A: $('div'),
    B: $('img.some_class'),
    C: $('#some_id'),
  ...
  for (var answerName in window.answerList){
    var answer = window.answerList[answerName], i = 0, ii = answer.length, tagList = {};
